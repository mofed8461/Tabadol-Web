...
<head>
    <link rel="stylesheet" type="text/css" href="imgs/css/style.css">
    ...
    <script language="javascript">
        ...
        function check()
        {
            ...
            var cpassword    = document.addform.cpassword.value;
            ...
            if( username =="")
            {
                alert("خطا : الرجاء ادخال اسم المستخدم.");
            }
            else if(password == "")
            {
                alert("خطا : الرجاء ادخال كلمة المرور.");
            }
            else if(password != cpassword)
            {
                alert("خطا : كلمة المرور غير متطابقة .");
            }
...
<form name="addform" method="post" action="adduser2.php" accept-charset="utf-8">
    <table align="center" style="margin-left: 35%;">
        ...
        <tr>
            <td height="55">اسم المستخدم</td>
            <td><input type="text" name="username"  /></td>
        </tr>
        <tr>
            <td height="55">كلمة المرور</td>
            <td><input type="password" name="password"  /></td>
        </tr>
        <tr>
            <td height="55">تأكيد كلمة المرور</td>
